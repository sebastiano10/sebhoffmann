  ...
  return (
    <main className="min-h-screen flex items-center relative overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full bg-[#8b7cf8]/[0.05] blur-[130px]" />
      </div>
          ...
          <div className="space-y-4">
            {contacts.map((contact) => (
              <Link
                ...
                className="group flex items-center justify-between p-5 rounded-2xl border border-white/[0.07] bg-[#0d0d1a] hover:border-[#8b7cf8]/30 hover:bg-[#0f0f1e] transition-all duration-300"
              >
                <div>
                  <p className="text-[#8b7cf8] text-[10px] font-semibold tracking-[0.2em] uppercase mb-1">
                    {contact.label}
                  </p>
                ...
                <svg
                  ...
                  className="text-[#7a8499] group-hover:text-[#8b7cf8] group-hover:translate-x-0.5 group-hover:-translate-y-0.5 transition-all duration-200 shrink-0 ml-4"
                >
